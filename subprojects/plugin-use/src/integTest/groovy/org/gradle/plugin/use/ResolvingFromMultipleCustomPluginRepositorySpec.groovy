...
class ResolvingFromMultipleCustomPluginRepositorySpec extends AbstractDependencyResolutionTest {
    ...
    @Shared String pluginA = "org.example.pluginA"
    @Shared String pluginAB = "org.example.pluginAB"
    ...
    private def use(MavenFileRepository... repositories) {
        args("-D${SettingsScopeServices.PLUGIN_REPOSITORY_SYSTEM_PROPERTY}=${repositories.collect{it.uri}.join(',') }")
    }
